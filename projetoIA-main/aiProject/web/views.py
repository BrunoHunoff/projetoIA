...
from aiProject.cidades.heuristicas import HEURISTICAS_MATRIZ  # heurísticas para algoritmos informados
...
def interface(request):
    ...
    # Gerar mapa por defeito ao carregar página (ex: Lisboa → Lisboa)
